...
const account2 = {
  ...
  movementsDates: [
    ...
    '2023-02-22T18:49:59.371Z',
    '2023-02-25T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
const updateUI = function (acc) {
  // Display and calculate movements
...
btnLoan.addEventListener('click', function (e) {
  ...
  // Check if the account qualifies for a loan
...
console.log(323048932809483209483209423233243244234233n);
console.log(BigInt(323048932));

// Operations
console.log(10000n + 10000n);
console.log(32424320409328504785743857345n * 1000000000n);
// console.log(Math.sqrt(16n));

const huge = 14324237432785684754375873465743545n;
const num = 23;
...
console.log(new Date('Feb 27 2023 00:54:44'));
...
// setTimeout
const ingredients = ['olives', 'spinach', 'pork'];
...
if (ingredients.includes('pork')) clearTimeout(pizzaTimer);
